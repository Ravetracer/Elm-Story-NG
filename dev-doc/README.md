...
| [theming-and-skins.md](theming-and-skins.md) | **Design (not built):** four-phase presentation plan — configurable reading-lane alignment, an author-locked bundled theme selector, a framed inventory grid, and curated 9-slice skin art; the schema costs, the layout coupling, and the licensing gate |
