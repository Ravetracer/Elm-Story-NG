...
| [preview-window.md](preview-window.md) | **Rejected feature:** an in-editor full-window preview window — dropped as unsafe (a same-origin player-mode window would install over the author's live database, and studio/world-scoped assets block isolating it); presentation is verified by exporting and viewing the export |
